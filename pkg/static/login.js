...
(function(console) {
    ...
    function display_legal_disclaimer_checkbox(display) {
        if (display === true) {
            show("#legal-disclaimer-group");
            login_failure(null); // Clear any existing errors
        } else {
            hide("#legal-disclaimer-group");
            id("acceptLegalDisclaimer").checked = false; // Uncheck the checkbox
            deleteDisclaimerCookie();
        }
    }
    ...
    function display_legal_disclaimer_text(display, text) {
        if (display === true) {
            show("#disclaimer-error-group");
        } else {
            hide("#disclaimer-error-group");
        }
